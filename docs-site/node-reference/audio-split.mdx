---
title: "Audio Split"
description: "Cut an audio source into two parts at one point on the waveform. Emits both halves as separate outputs."
sidebarTitle: "Audio Split"
---

<Frame caption="Audio Split · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Audio Split" />
</Frame>

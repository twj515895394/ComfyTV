---
title: "Audio Trim"
description: "Cut audio to a [start_s, end_s] range on a waveform timeline. Accepts audio or video input; emits a single trimmed audio snapshot."
sidebarTitle: "Audio Trim"
---

<Frame caption="Audio Trim · screenshot coming soon">
  <img src="/images/nodes/_placeholder.svg" alt="Audio Trim" />
</Frame>
